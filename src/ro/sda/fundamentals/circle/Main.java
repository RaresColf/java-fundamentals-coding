package ro.sda.fundamentals.circle;
  /*
...
public class Main {
    ...
    public static void main(String[] args) {
        Circle cerc = new Circle(3.75);
        System.out.println( " Circle radius " + cerc.getRadius());
        System.out.println(" Circle area" + cerc.getArea());

        Cylinder cilindru = new Cylinder(5.5, 7.25);
        System.out.println(" Cylinder radius " + cilindru.getRadius());
        System.out.println(" Cylinder height " + cilindru.getHeight());
