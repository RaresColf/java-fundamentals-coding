...
public class Main {
    public static void main(String[] args) {
        ...
        Contact contact1 = new Contact("Ionel", "444");
        Contact contact2 = new Contact("Mirel", "333");
        Contact contact3 = new Contact("Jhonny", "666");
        ...
        MobilePhone mobilePhone = new MobilePhone("555", contactList);

        mobilePhone.printContact();

        System.out.println(" Index:" + mobilePhone.findContact("Jhonny"));
        System.out.println(" Index:" + mobilePhone.findContact("Gigel")); // gigel nu exista in lista si returneaza -1

        mobilePhone.addNewContact(new Contact("Catalin","777"));
        mobilePhone.printContact();

        Contact contactForUpdate = new Contact("Tica", "888");

        mobilePhone.updateContact(contact1, contactForUpdate);
        mobilePhone.printContact();

        mobilePhone.removeContact(contactForUpdate);
        mobilePhone.printContact();
